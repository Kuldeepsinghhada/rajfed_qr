...
class FarmerSearchByQR extends StatefulWidget {
  const FarmerSearchByQR({super.key});
  @override
  State<FarmerSearchByQR> createState() => _FarmerSearchByQRState();
}

class _FarmerSearchByQRState extends State<FarmerSearchByQR> {
  String userName = "";
